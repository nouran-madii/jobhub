...
export default function AppliedJobsPage() {
  return (
    <div className="bg-[#F3F3F3] text-[#1a1a1a]">
      {/* Hero */}
      <div className="relative  w-full h-[340px] bg-cover   bgHistory" >
  {/* التغميقة السوداء */}
  <div className="absolute inset-0 bg-black bg-opacity-40"></div>

  {/* النص فوق التغميقة */}
  <h1 className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-4xl font-semibold">
    Applied Jobs
  </h1>
</div>
      ...
      <div className="max-w-5xl mx-auto space-y-6 px-4">
        {jobs.map((job, index) => (
          <div key={index} className="bg-white rounded-lg shadow p-6 flex justify-between">
            <div>
            ...
            {/* {job.logo} */}
              ...
              <a href="#" className="text-[#5D3B09] underline text-sm block mt-4">Rate The Company</a>
            </div>
          </div>
        ))}
      </div>
